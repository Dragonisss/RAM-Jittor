...
from data.low_cost_dataset import LowCostDataset
from data.lolv2_dataset import LOLv2Dataset
from data.utils.online_util import parse_degradations
import random
...
class RAMDataset(Dataset):
    def __init__(self, opt):
        ...
        high_cost_datasets = [self.lol_dataset]
